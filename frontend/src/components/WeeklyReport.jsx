...
export default function WeeklyReport({ report }) {
  ...
  const { totalIncome, totalExpenses, balance, topCategories, dailyBreakdown } = report;
  ...
  return (
    <div>
      ...
      {/* Chart + categories side by side on larger screens */}
        ...
        <div className="lg:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart data={dailyBreakdown} margin={{ top: 0, right: 4, left: -20, bottom: 0 }}>
              ...
              <Bar dataKey="expenses" name="Expenses" fill="#f87171" radius={[3, 3, 0, 0]} maxBarSize={18} />
            </BarChart>
          </ResponsiveContainer>
        </div>
                ...
                return (
                  <div key={c.category}>
                    ...
                    <div className="h-1.5 bg-dark-700 rounded-full overflow-hidden">
                      <div className="h-full bg-primary-500/70 rounded-full" style={{ width: `${pct}%` }} />
                    </div>
                  </div>
                );
              })}
